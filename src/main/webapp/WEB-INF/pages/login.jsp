...
<head>
<title>Login</title>
<link href="WEB-INF/pages/css/bootstrap.css" rel="stylesheet" type="text/css" media="all"/>
<link href="WEB-INF/pages/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="WEB-INF/pages/css/owl.carousel.css" rel="stylesheet">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Swim Wear Responsive web template, Bootstrap Web Templates, Flat Web Templates, Andriod Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<script src="WEB-INF/pages/js/jquery.min.js"></script>
<!-- cart -->
		<script src="js/simpleCart.min.js"> </script>
	<!-- cart -->
<script type="text/javascript" src="js/bootstrap-3.1.1.min.js"></script>
<script src="WEB-INF/pages/js/imagezoom.js"></script>

						<!-- FlexSlider -->
  <script defer src="WEB-INF/pages/js/jquery.flexslider.js"></script>
<link rel="stylesheet" href="WEB-INF/pages/css/flexslider.css" type="text/css" media="screen" />
